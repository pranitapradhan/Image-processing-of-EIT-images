...
max_TV_locs= Maximas_New([2:14,16:23,25:31,33:39,41:end]);
min_TV_locs= Minimas_New([1:13,15:22,24:30,32:38,40:end]);
...
FB4=F1(1:16,17:32);
 ...
 FB1_sum = sum(sum(FB1));
 rat1=FB1_sum/Body_plyt(3,2);
 
 %--- Tidal Volume for 2st half--%
 FB2_sum = sum(sum(FB2));
 rat2=FB2_sum/Body_plyt(3,2);
 
 %--- Tidal Volume for 3rd half--%
 FB3_sum = sum(sum(FB3));
 rat3=FB3_sum/Body_plyt(3,2);
 
 %--- Tidal Volume for 4th half--%
 FB4_sum = sum(sum(FB4));
 rat4=FB4_sum/Body_plyt(3,2);